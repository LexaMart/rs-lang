...
export const Main = () => {
  ...
  const getWords = useCallback(async () => {
    try {
      ...
      const fetched = await request(
        `https://rs-lang-74-api.herokuapp.com/words?group=${currentWordsGroup}&page=${currentWordsPage}`,
        'GET'
      );
      setData(fetched);
  ...
  const changePage = (incr) => {
    if (
      currentWordsPage + incr < 0 ||
      currentWordsPage + incr > MAIN_CONSTANTS.maxPage
    ) {
      return;
    }
  ...
  return (
    <div>
      <div className="groups">
        <div
          className={
            currentWordsGroup === MAIN_CONSTANTS.groupNum[0]
              ? 'btn group group_1'
              : 'btn group'
          }
          onClick={() => changeGroup(MAIN_CONSTANTS.groupNum[0])}
        >
          {language === LANGUAGE_CONFIG.foreign
            ? WORDS_CONFIG.MAIN_PAGE_GROUP.foreign
            : WORDS_CONFIG.MAIN_PAGE_GROUP.native}{' '}
          1
        </div>
        <div
          className={
            currentWordsGroup === MAIN_CONSTANTS.groupNum[1]
              ? 'btn group group_2'
              : 'btn group'
          }
          onClick={() => changeGroup(MAIN_CONSTANTS.groupNum[1])}
        >
          {language === LANGUAGE_CONFIG.foreign
            ? WORDS_CONFIG.MAIN_PAGE_GROUP.foreign
            : WORDS_CONFIG.MAIN_PAGE_GROUP.native}{' '}
        ...
        <div
          className={
            currentWordsGroup === MAIN_CONSTANTS.groupNum[2]
              ? 'btn group group_3'
              : 'btn group'
          }
          onClick={() => changeGroup(MAIN_CONSTANTS.groupNum[2])}
        >
          {language === LANGUAGE_CONFIG.foreign
            ? WORDS_CONFIG.MAIN_PAGE_GROUP.foreign
            : WORDS_CONFIG.MAIN_PAGE_GROUP.native}{' '}
        ...
        <div
          className={
            currentWordsGroup === MAIN_CONSTANTS.groupNum[3]
              ? 'btn group group_4'
              : 'btn group'
          }
          onClick={() => changeGroup(MAIN_CONSTANTS.groupNum[3])}
        >
          {language === LANGUAGE_CONFIG.foreign
            ? WORDS_CONFIG.MAIN_PAGE_GROUP.foreign
            : WORDS_CONFIG.MAIN_PAGE_GROUP.native}{' '}
        ...
        <div
          className={
            currentWordsGroup === MAIN_CONSTANTS.groupNum[4]
              ? 'btn group group_5'
              : 'btn group'
          }
          onClick={() => changeGroup(MAIN_CONSTANTS.groupNum[4])}
        >
          {language === LANGUAGE_CONFIG.foreign
            ? WORDS_CONFIG.MAIN_PAGE_GROUP.foreign
            : WORDS_CONFIG.MAIN_PAGE_GROUP.native}{' '}
        ...
        <div
          className={
            currentWordsGroup === MAIN_CONSTANTS.groupNum[5]
              ? 'btn group group_6'
              : 'btn group'
          }
          onClick={() => changeGroup(MAIN_CONSTANTS.groupNum[5])}
        >
          {language === LANGUAGE_CONFIG.foreign
            ? WORDS_CONFIG.MAIN_PAGE_GROUP.foreign
            : WORDS_CONFIG.MAIN_PAGE_GROUP.native}{' '}
      ...
      <div className="navigation">
        <i
          id="arrow"
          className="material-icons white-text btn"
