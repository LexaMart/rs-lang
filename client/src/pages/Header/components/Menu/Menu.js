    ...
    <>
      ...
      <div style={!active ? { left: "8000px" } : { left: "70%" }} className="menu-block">
        <ul className="menu-nav">
          ...
          <Link onClick={() => setActive(!active)} className="menu-nav-link" to="/promo">{activeLang === LANGUAGE_CONFIG.foreign ? WORDS_CONFIG.PROMO_PAGE.foreign : WORDS_CONFIG.PROMO_PAGE.native}</Link>
